<div class="modal fade show" id="pasaje-pagado-edit" aria-modal="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body" id="pasaje-pagado-edit-body">
                <span v-if="adicional">
                                ...
                                <div class="card card-success">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="date" name="created_at_venta" v-model="pasaje.created_at_venta"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <select name="aerolinea_id" class="form-control" v-model="pasaje.aerolinea_id" @change="filtroPorId">
                                                            ...
                                                            <option v-for="aero in filtro_aerolineas" :key="aero.id" :value="aero.id">
                                                                @{{aero.name}}
                                                            </option>
                                                        </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" name="viajecode" id="product_code" v-model="pasaje.viajecode"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="col-lg-offset-2 col-lg-10">
                                        <button type="button" class="btn btn-success" @click="guardarPasaje">
